...
import CompleteSplitTable from '@/components/CompleteSplitTable/index.tsx';
import { ExpandableConfig } from 'rc-table/lib/interface';

type CompleteTSplitTableWrapperProps<T> = {
  initData: T[];
...
function CompleteSplitTableWrapper<T>(
  props: CompleteTSplitTableWrapperProps<T>
) {
  const {
    expandable,
    gapHeightArrayProps,
...
export default CompleteSplitTableWrapper;
